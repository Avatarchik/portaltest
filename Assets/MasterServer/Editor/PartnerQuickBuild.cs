...
public class PartnerQuickBuild
{
    ...
    [MenuItem("Tools/PartnerMaster/Build All", false, 0)]
    ...
    public static void BuildClient(string path)
    {
        var clientScenes = new[]
        {
            ...
            QuickSetupRoot + "/Scenes/GameLevels/PartnerChamber1.unity"
        };
    ...
    [MenuItem("Tools/PartnerMaster/Build Master + Spawner", false, 11)]
    ...
    [MenuItem("Tools/PartnerMaster/Build Client", false, 11)]
    ...
    [MenuItem("Tools/PartnerMaster/Build Game Server", false, 11)]
